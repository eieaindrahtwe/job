...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('frontend_assets/css/custom-bs.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('frontend_assets/fonts/line-icons/style.css')}}">
...
<div class="site-wrap">
        ...
        <div class="row align-items-center">
          ...
          <nav class="mx-auto site-navigation">
            <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
              ...
              <li><a href="about.html">Top Companies</a></li>
              <li class="has-children">
                <a href="job-listings.html"><span class="mr-2 icon-lock_outline"></span>Employer</a>
                <ul class="dropdown">
                  <li><a href="job-single.html">Regiter</a></li>
                  <li><a href="post-job.html">Login</a></li>
                </ul>
              </li>
              <li class="has-children">
                <a href="job-listings.html"><span class="mr-2 icon-lock_outline"></span>Job Seeker</a>
                <ul class="dropdown">
                  <li><a href="job-single.html">Regiter</a></li>
                  <li><a href="post-job.html">Login</a></li>
                </ul>
  ...
  <script src="{{asset('frontend_assets/js/stickyfill.min.js')}}"></script>
